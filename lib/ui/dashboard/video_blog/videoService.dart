...
class VideoServices {
  ...
  String imgPath;
  Source source;
  VideoServices({this.title,this.videoUrl,this.description,this.addedDate,this.addedDateStr,this.imgPath,this.source
  });
  factory VideoServices.fromJson(Map<String, dynamic> json) {
    return VideoServices(
      ...
      source: Source.fromJson(json["default_icon"])
    );}
}
