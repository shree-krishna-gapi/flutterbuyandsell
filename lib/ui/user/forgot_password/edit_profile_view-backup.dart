    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          PsTextFieldWidget(
              titleText: Utils.getString(context, 'edit_profile__user_namea'),
              hintText: Utils.getString(context, 'edit_profile__user_namea'),
              textAboutMe: false,
          ...
          // Text('$stateId'),
          stateId == '' || stateId == null ? Container():
          Container(
            child: ProfileAddress(stateId: int.parse(stateId)),
          ),
          PsTextFieldWidget(
